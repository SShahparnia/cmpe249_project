...
- **Shervan Shahparnia** — simulation & infrastructure; evaluation & Jetson deployment
- **Joey Manivong** — simulation & infrastructure; exploration algorithms
- **Aaron Sam** — exploration algorithms; evaluation & Jetson deployment
...
|---|---|---|
| **A** | GitHub repo + README (title, team, abstract, track) | this file |
| **B** | Literature & SOTA survey — 10 papers, 2023–2026 | [`docs/LITERATURE_SURVEY.md`](docs/LITERATURE_SURVEY.md) |
...
| **D** | AI novelty & feasibility audit | [`docs/AI_NOVELTY_AUDIT.md`](docs/AI_NOVELTY_AUDIT.md) |
